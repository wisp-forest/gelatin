...
public class JelloBlockVariants {
    ...
    }).setDefaultBlock("slime_slab").setBlockTags(JelloTags.Blocks.COLORED_SLIME_SLABS, JelloTags.Blocks.STICKY_BLOCKS).setLootTable(block -> JelloLootTables.slabDrops(block).build()).register();
