...
public class ArtistPaletteRecipe extends SpecialCraftingRecipe {
        ...
        if (craftingInventory.getWidth() == 3 && craftingInventory.getHeight() == 3) {
            ...
            for(int i = 0; i < craftingInventory.getWidth(); ++i) {
                for(int j = 0; j < craftingInventory.getHeight(); ++j) {
                    ...
                    if (i == 1 && j == 1) {
                        if (!itemStack.isOf(ItemRegistry.MainItemRegistry.EMPTY_ARTIST_PALETTE)) {
                            return false;
                        }
    ...
    public ItemStack craft(CraftingInventory craftingInventory) {
        ...
        if (!itemStack.isOf(ItemRegistry.MainItemRegistry.EMPTY_ARTIST_PALETTE)) {
            ...
            ItemStack itemStack2 = new ItemStack(ItemRegistry.MainItemRegistry.ARTIST_PALETTE, 1);
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializerRegistry.ARTIST_PALETTE;
    }
}
