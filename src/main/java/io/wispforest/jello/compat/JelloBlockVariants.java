...
public class JelloBlockVariants {
    ...
    }).setDefaultBlock(new Identifier("slime_block")).setBlockTags(JelloTags.Blocks.SLIME_BLOCKS, JelloTags.Blocks.COLORED_SLIME_BLOCKS).setItemTags(JelloTags.Items.SLIME_BLOCKS).register();
    ...
    }).setDefaultBlock("slime_slab").setBlockTags(JelloTags.Blocks.SLIME_SLABS, JelloTags.Blocks.COLORED_SLIME_SLABS).setItemTags(JelloTags.Items.SLIME_SLABS).register();
