package com.dragon.jello.main.client.data;
...
import com.dragon.jello.main.mixin.mixins.client.accessors.ItemModelGeneratorAccessor;
import com.dragon.jello.main.mixin.mixins.client.accessors.ModelsAccessor;
...
public class JelloBlockStateProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        ItemRegistry.SlimeBallItemRegistry.SLIME_BALLS.forEach((item) -> {
            ...
            model.upload(ModelIds.getItemModelId(item), (new TextureMap()).put(TextureKey.LAYER0, new Identifier(Jello.MODID, "item/slime_ball_gray")), ((ItemModelGeneratorAccessor)itemModelGenerator).getWriter());
        });

        Model template_cup = ModelsAccessor.callItem("generated", TEXTURE0, TEXTURE1);
        template_cup.upload(new Identifier(Jello.MODID, "item/" + "template_cup"), (new TextureMap())
        ...
        jelloItem("template_cup", TextureKey.LAYER0, LAYER1)
            .upload(ModelIds.getItemModelId(ItemRegistry.JelloCupItemRegistry.SUGAR_CUP), (new TextureMap())
