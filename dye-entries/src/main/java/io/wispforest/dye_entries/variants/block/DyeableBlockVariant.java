package io.wispforest.dye_entries.variants.block;
...
import io.wispforest.dye_entries.variants.DyeableVariant;
...
import io.wispforest.dye_entries.variants.item.ItemMaker;
...
public class DyeableBlockVariant extends DyeableVariant<DyeableBlockVariant, Block> {
    ...
    public DyeableBlockVariant(Identifier variantIdentifier, @Nullable Supplier<DyeableBlockVariant> possibleChildVariant, Item.Settings itemSettings, @Nullable BlockMaker blockMaker) {
        ...
        allBlockTags.add(TagKey.of(Registry.BLOCK_KEY, GelatinConstants.id(variantIdentifier.getPath())));
    }
    ...
    public static class Builder {
         ...
         */
        public final Builder setBlockStateChangeMethod(BlockColorManipulators.AlterBlockColor method){
    ...
    public static DyeableBlockVariant getVariantFromBlock(ItemConvertible convertible){
        return getVariantFromBlock(BetterItemOps.getIdFromConvertible(convertible));
    }
    ...
    protected final void addToBlockTags(Block block, boolean readOnly) {
        ...
        if(!defaultEntryIdentifier.getPath().contains("white") && !initilizedDefaultBlocksBlockTag) { //&& block != this.getDefaultBlock()
